...
//2024/11/08 modified
/* 19 */		F_DISABLE 	/* F_ACTIVATE_SQLPLUS */			/* , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */ ,	//Oracle SQL*Plusをアクティブ表示 */	//Sept. 20, 2000 JEPRO 追加
/* 20 */		F_DISABLE 	/* F_PLSQL_COMPILE_ON_SQLPLUS */	/* , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */ ,	//Oracle SQL*Plusで実行 */	//Sept. 17, 2000 jepro 説明の「コンパイル」を「実行」に統一
...
)
{
	...
	//2024/11/08 modified
	if (strcmp((const char *)mii.dwTypeData, "") == 0)
	{
		return;
	}
	else
